...
class GoogleMapController {
  ...
  MethodChannel? get channel {
    if (GoogleMapsFlutterPlatform.instance is MethodChannelGoogleMapsFlutter) {
      return (GoogleMapsFlutterPlatform.instance as MethodChannelGoogleMapsFlutter).channel(mapId);
    }
    return null;
  }
  ...
  Future<void> _updateMapOptions(Map<String, dynamic> optionsUpdate) {
    ...
    return GoogleMapsFlutterPlatform.instance.updateMapOptions(optionsUpdate, mapId: mapId);
  }
